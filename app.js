...
app.get('/login', (req, res) => {
    ...
    const url = `https://access.line.me/oauth2/v2.1/authorize?response_type=code&client_id=${process.env.LINE_CHANNEL_ID}&redirect_uri=${req.protocol}://${req.get('host')}/auth/line/callback&state=${state}&scope=profile%20openid`;
    res.redirect(url);
});
